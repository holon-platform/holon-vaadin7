...
public class ValueChangeNotifierRegistration implements Registration {
	...
	/**
	 * Adapt an {@link Input} {@link com.holonplatform.vaadin.components.Input.ValueChangeListener} and register it in
	 * given notifier.
	 * @param source Source {@link Input}
	 * @param notifier Actual {@link ValueChangeNotifier}
	 * @param listener Listener to adapt
	 * @return Listener registration
	 */
	public static <V> Registration adapt(Input<V> source, ValueChangeNotifier notifier,
