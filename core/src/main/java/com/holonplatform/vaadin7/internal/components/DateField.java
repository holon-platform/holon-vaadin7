...
import com.holonplatform.vaadin7.internal.components.builders.AbstractDateFieldBuilder;
...
public class DateField extends com.vaadin.ui.DateField implements Input<Date>, RequiredIndicatorSupport {
	...
	public Registration addValueChangeListener(
			com.holonplatform.vaadin7.components.Input.ValueChangeListener<Date> listener) {
