...
import com.holonplatform.vaadin7.internal.components.builders.AbstractFieldBuilder;
...
public class BooleanField extends CheckBox implements Input<Boolean>, RequiredIndicatorSupport {
	...
	public Registration addValueChangeListener(
			com.holonplatform.vaadin7.components.Input.ValueChangeListener<Boolean> listener) {
