...
public class DefaultOrderedLayoutConfigurator<I extends AbstractOrderedLayout & LayoutClickNotifier & Layout.AlignmentHandler & Layout.SpacingHandler & Layout.MarginHandler>
	 ...
	 */
	@Override
	public com.holonplatform.vaadin7.components.builders.OrderedLayoutConfigurator.BaseOrderedLayoutConfigurator expand(
	 ...
	 */
	@Override
	public com.holonplatform.vaadin7.components.builders.OrderedLayoutConfigurator.BaseOrderedLayoutConfigurator addAndExpand(
			Component component, float expandRatio) {
	 ...
	 */
	@Override
	public com.holonplatform.vaadin7.components.builders.OrderedLayoutConfigurator.BaseOrderedLayoutConfigurator addAlignAndExpand(
	 ...
	 */
	@Override
	protected com.holonplatform.vaadin7.components.builders.OrderedLayoutConfigurator.BaseOrderedLayoutConfigurator builder() {
		return this;
	}
