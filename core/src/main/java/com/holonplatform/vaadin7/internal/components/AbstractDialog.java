...
public abstract class AbstractDialog extends Window implements Dialog, CloseListener {
	 ...
	 * Close listeners
	 */
	private final List<com.holonplatform.vaadin7.components.Dialog.CloseListener> closeListeners = new LinkedList<>();
	 ...
	 */
	@Override
	public Registration addCloseListener(com.holonplatform.vaadin7.components.Dialog.CloseListener listener) {
	...
	/**
	 * Closes the dialog
	 * @param actionId Action id to provide to dialog {@link com.holonplatform.vaadin7.components.Dialog.CloseListener}s.
	 */
	...
	protected void fireCloseListeners(Object actionId) {
		for (com.holonplatform.vaadin7.components.Dialog.CloseListener listener : closeListeners) {
	...
	static abstract class AbstractBuilder<D extends AbstractDialog, B extends Builder<B>>
		 ...
		 */
		@Override
		public B withCloseListener(com.holonplatform.vaadin7.components.Dialog.CloseListener closeListener) {
