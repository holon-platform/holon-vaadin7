...
public class DefaultButtonConfigurator extends AbstractComponentConfigurator<Button, BaseButtonConfigurator>
	 ...
	 */
	@Override
	public com.holonplatform.vaadin7.components.builders.ButtonConfigurator.BaseButtonConfigurator tabIndex(
			int tabIndex) {
	 ...
	 */
	@Override
	public com.holonplatform.vaadin7.components.builders.ButtonConfigurator.BaseButtonConfigurator withFocusListener(
	 ...
	 */
	@Override
	public com.holonplatform.vaadin7.components.builders.ButtonConfigurator.BaseButtonConfigurator withBlurListener(
	 ...
	 */
	@Override
	public com.holonplatform.vaadin7.components.builders.ButtonConfigurator.BaseButtonConfigurator iconAlternateText(
			String iconAltText) {
	 ...
	 */
	@Override
	public com.holonplatform.vaadin7.components.builders.ButtonConfigurator.BaseButtonConfigurator onClick(
	 ...
	 */
	@Override
	protected com.holonplatform.vaadin7.components.builders.ButtonConfigurator.BaseButtonConfigurator builder() {
		return this;
	}
