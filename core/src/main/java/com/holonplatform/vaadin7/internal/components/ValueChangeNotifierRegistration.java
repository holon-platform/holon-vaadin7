...
public class ValueChangeNotifierRegistration implements Registration {
	...
	/**
	 * Adapt a {@link ValueHolder} {@link com.holonplatform.vaadin7.components.ValueHolder.ValueChangeListener} and
	...
	public static <V> Registration adapt(ValueHolder<V> source, ValueChangeNotifier notifier,
			com.holonplatform.vaadin7.components.ValueHolder.ValueChangeListener<V> listener) {
