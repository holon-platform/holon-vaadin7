...
import com.holonplatform.vaadin7.internal.components.ValueChangeNotifierRegistration;
...
public abstract class AbstractFieldConfigurator<T, C extends AbstractField<T>, B extends InputConfigurator<T, B>>
	...
	@Override
	public B withValueChangeListener(com.holonplatform.vaadin7.components.ValueHolder.ValueChangeListener<T> listener) {
