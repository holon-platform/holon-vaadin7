...
import com.holonplatform.vaadin7.navigator.internal.ContainerViewDisplay;
...
public class DefaultSpringViewNavigator extends SpringNavigator implements ViewNavigatorAdapter, SpringViewNavigator {
	...
	public static class SpringViewNavigatorBuilder
		 ...
		 */
		@Override
		protected com.holonplatform.vaadin7.spring.SpringViewNavigator.Builder builder() {
			return this;
		}
		 ...
		 */
		@Override
		public com.holonplatform.vaadin7.spring.SpringViewNavigator.Builder errorView(Class<? extends View> viewClass) {
		 ...
		 */
		@Override
		public com.holonplatform.vaadin7.spring.SpringViewNavigator.Builder accessDeniedView(
